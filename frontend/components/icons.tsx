...
export const CopyIcon = ({ size = 16 }: { size?: number }) => (
  ...
  >
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M0 2C0 0.895431 0.895431 0 2 0H10C11.1046 0 12 0.895431 12 2V4H14C15.1046 4 16 4.89543 16 6V14C16 15.1046 15.1046 16 14 16H6C4.89543 16 4 15.1046 4 14V12H2C0.895431 12 0 11.1046 0 10V2ZM5.5 12V14C5.5 14.2761 5.72386 14.5 6 14.5H14C14.2761 14.5 14.5 14.2761 14.5 14V6C14.5 5.72386 14.2761 5.5 14 5.5H12V10C12 11.1046 11.1046 12 10 12H5.5ZM2 1.5C1.72386 1.5 1.5 1.72386 1.5 2V10C1.5 10.2761 1.72386 10.5 2 10.5H10C10.2761 10.5 10.5 10.2761 10.5 10V2C10.5 1.72386 10.2761 1.5 10 1.5H2Z"
      fill="currentColor"
    />
  </svg>
);
...
export const PlayIcon = ({ size = 16 }: { size?: number }) => (
  ...
  >
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M3.5 2.75C3.5 2.28587 3.97354 1.96642 4.375 2.20096L12.875 7.45096C13.2765 7.6855 13.2765 8.3145 12.875 8.54904L4.375 13.799C3.97354 14.0336 3.5 13.7141 3.5 13.25V2.75Z"
      fill="currentColor"
    />
  </svg>
);
...
export const DownloadIcon = ({ size = 16 }: { size?: number }) => (
  ...
  >
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M7.25 1.75V1H8.75V1.75V9.43934L10.4697 7.71967L11 7.18934L12.0607 8.25L11.5303 8.78033L8.28033 12.0303C8.12968 12.181 7.93891 12.25 7.74 12.25C7.54109 12.25 7.35032 12.181 7.19967 12.0303L3.94967 8.78033L3.41934 8.25L4.48 7.18934L5.01033 7.71967L6.75 9.45934V1.75H7.25ZM2.25 11.75H1.5V13.25H2.25H13.75H14.5V11.75H13.75H2.25Z"
      fill="currentColor"
    />
  </svg>
);
...
export const OpenAstraIcon = ({ size = 16 }: { size?: number }) => {
  return (
    <svg
      height={size}
      strokeLinejoin="round"
      ...
      role="img"
    >
      <path d="M16.975 3.036c6.402.475 11.514 5.586 11.99 11.989H24.32a7.345 7.345 0 0 1-7.345-7.345V3.036Zm-1.95 21.284v4.644c-6.402-.475-11.514-5.587-11.989-11.99H7.68a7.345 7.345 0 0 1 7.345 7.346Z" />
      <path d="M3.036 15.025c.475-6.403 5.587-11.514 11.99-11.99V7.68a7.345 7.345 0 0 1-7.346 7.345H3.036Zm21.284 1.95h4.644c-.475 6.402-5.586 11.514-11.989 11.989V24.32a7.345 7.345 0 0 1 7.345-7.345Z" />
    </svg>
  );
};
