...
export const OpenAstraIcon = ({ size = 16 }: { size?: number }) => {
  return (
    <svg height={size} strokeLinejoin="round" width={size} fill="currentColor" viewBox="0 0 32 32" role="img">
...
export const MessageCirclePlusIcon = ({ size = 16 }: { size?: number }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export const ProjectsIcon = ({ size = 16 }: { size?: number }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export const CaretSortIcon = ({ size = 16 }: { size?: number }) => {
  return (
...
export const PlusCircledIcon = ({ size = 16 }: { size?: number }) => {
  return (
    <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
